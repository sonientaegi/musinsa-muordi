...
class ExploreServiceTest {
    ...
    void getCheapestByCategory() {
        List<ItemNamedDto> expecteds = List.of(
        ...
        CategoryBrandCheapestDto actuals = this.exploreService.getCheapestByCategory();
    ...
    void getCheapestBrand() {
        List<ItemNamedDto> expecteds = List.of(
                ItemNamedDto.builder().categoryName("상의").brandName("D").categoryId(1).brandId(4).price(11000).build(),
                ItemNamedDto.builder().categoryName("아우터").brandName("D").categoryId(2).brandId(4).price(5100).build(),
                ItemNamedDto.builder().categoryName("바지").brandName("D").categoryId(3).brandId(4).price(3000).build(),
                ItemNamedDto.builder().categoryName("스니커즈").brandName("D").categoryId(4).brandId(4).price(9500).build(),
                ItemNamedDto.builder().categoryName("가방").brandName("D").categoryId(5).brandId(4).price(2500).build(),
                ItemNamedDto.builder().categoryName("모자").brandName("D").categoryId(6).brandId(4).price(1500).build(),
                ItemNamedDto.builder().categoryName("양말").brandName("D").categoryId(7).brandId(4).price(2400).build(),
                ItemNamedDto.builder().categoryName("액세서리").brandName("D").categoryId(8).brandId(4).price(2000).build()
        );
        BrandCheapestDto actuals = this.exploreService.getCheapestBrand();
        assertNotNull(actuals);
    ...
    void priceRangeofCategoryByName() {
        CategoryPriceRangeDto expected = CategoryPriceRangeDto.builder()
                .categoryName("상의")
                .categoryId(1)
                .minPriceRecord(ItemNamedDto.builder().categoryName("상의").categoryId(1).brandName("C").brandId(3).price(10000).build())
                .maxPriceRecord(ItemNamedDto.builder().categoryName("상의").categoryId(1).brandName("I").brandId(9).price(11400).build())
                .build();
        CategoryPriceRangeDto actual = this.exploreService.PriceRangeofCategoryByName("상의");
