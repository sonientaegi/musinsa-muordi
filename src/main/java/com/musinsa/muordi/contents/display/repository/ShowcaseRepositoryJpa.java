 ...
 */
@Component
public interface ShowcaseRepositoryJpa extends JpaRepository<Showcase, Integer>, AtomicUpdateById<Showcase, Integer> {
    /**
...
//    List<Showcase> findAllByBrand_Name(String brandName);
     ...
     */
    void deleteShowcaseByProduct_Id(Long productId);
}
