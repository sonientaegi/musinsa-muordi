...
public interface ShowcaseRepository {
     ...
     */
    Optional<Showcase> findByProductId(long productId);
     ...
     */
    List<Showcase> findByBrandId(int brandId);
     ...
     * @return 쇼케이스 entity 리스트를 반환한다.
     */
    List<Showcase> findByBrandName(String brandName);
     ...
     * @return 쇼케이스 entity 리스트를 반환한다.
     */
    List<Showcase> findByCategoryId(int categoryId);
     ...
     * @return 쇼케이스 entity 리스트를 반환한다.
     */
    List<Showcase> findByCategoryName(String categoryName);
